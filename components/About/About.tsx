...
const About = () => {
  ...
  I admit I am just starting out with that.
  My goal is to always improve my skills as a programmer and designer, and
  my intent is to apply the same drive I have for self-improvement
  to any projects I work on.
  On the frontend side, I have mostly worked in HTML, CSS and vanilla 
  JavaScript, but I have begun to work with React on Typescript which is what 
  I used to build this portfolio of mine. For prototyping I stick to FramerX. 
  Backend wise, I tend to use Flask but I have begun dabbling in Node.js, and
  GoLang, with MongoDB.`
        ...
        <div style={{ overflow: 'hidden' }}>
          ...
          <Container>
            <div>
              ...
              <Description>
                Hailing from India, I'm currently a Sophomore at the University
                of Southern California, Los Angeles studying Computer Science and 
...
const StopButtonContainer = styled.div`
  ...
  height: 5rem;
  width: 5rem;
  filter: drop-shadow(0 0 0.75rem rgba(0, 136, 255, 0.3));
  border-radius: 50%;
  display: flex;
  align-items: center;
